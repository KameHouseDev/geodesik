...
const TopBar = () => {
  return (
    <>
      {/* Banner promocional */}
      <div className="bg-gold text-slate-900 py-2 text-center text-xs sm:text-sm font-semibold tracking-wide">
        <span className="inline-flex items-center gap-2">
          <FaFire className="text-red-600 animate-pulse" />
          🎁 ¡FINANCIAMIENTO DISPONIBLE! Consulta por cuotas sin interés — 
          <a href="#contacto" className="underline hover:no-underline ml-1 font-bold">Cotiza GRATIS hoy</a>
          <FaFire className="text-red-600 animate-pulse" />
        </span>
      </div>

      <div className="bg-navy-dark text-white py-3 text-sm">
